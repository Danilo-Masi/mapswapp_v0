...
type AppContextType = {
    ...
    // Waitlist
    isWaitlistDialogOpen: boolean;
    setWaitlistDialogOpen: Dispatch<SetStateAction<boolean>>;
    subscribedSuccessfully: boolean;
    setSubscribedSuccessfully: Dispatch<SetStateAction<boolean>>;
};
...
export const AppProvider = ({ children }: { children: ReactNode }) => {
    ...
    // Waitlist
    const [isWaitlistDialogOpen, setWaitlistDialogOpen] = useState(false);
