...
export default function ItineraryCard({ id, image, title, country, city, duration, shortDescription, spots, price, authorName, authorAvatar, rating, reviewCount, badge }: ItineraryCardInterface) {
    ...
    return (
        ...
        >
            ...
            {/* PRICE (top-right, sempre visibile) */}
